...
// 添加新<div>标记如下：
let container1 = document.getElementById('container1'); // 选择id属性为'container1'的标记
let div2 = document.createElement('div');               // 新建<div>标记
div2.innerHTML = 'js添加的标记';                         // 修改
container1.appendChild(div2);                           // 添加到container1中
